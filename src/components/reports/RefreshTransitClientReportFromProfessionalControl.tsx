...
import { refreshTransitClientReportFromProfessional } from "@/lib/reports/transits/client-report/actions";

type RefreshTransitClientReportFromProfessionalControlProps = {
  clientId: string;
  transitAnalysisId: string;
  professionalReportId: string;
};

export function RefreshTransitClientReportFromProfessionalControl({
  clientId,
  transitAnalysisId,
  professionalReportId,
}: RefreshTransitClientReportFromProfessionalControlProps) {
  ...
  async function handleRefresh() {
    ...
    const result = await refreshTransitClientReportFromProfessional({
      clientId,
      transitAnalysisId,
      professionalReportId,
    });
